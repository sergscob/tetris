...
import { joinRoom, startGame, roomStateReceived, socketErrorReceived, JOIN_ROOM, START_GAME } from '../../src/client/actions/room';
import { move, rotate, softDrop, hardDrop, gameStarted, gameTick, gameOver } from '../../src/client/actions/game';
...
describe('client/actions', () => {
  ...
  it('game actions carry their type, input direction, and server-originated payloads', () => {
